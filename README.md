...
[![Release](https://img.shields.io/github/v/release/latest-debs/lf-debian)](https://github.com/latest-debs/lf-debian/releases)
[![Build](https://github.com/latest-debs/lf-debian/actions/workflows/release.yml/badge.svg)](../../actions)

[lf](https://github.com/gokcehan/lf) — terminal file manager — packaged for
...
Or download a `.deb` from the [Releases](https://github.com/latest-debs/lf-debian/releases) page:

```sh
sudo apt install ./lf_*.deb
```
...
Run the [Build lf for Debian](../../actions) workflow on GitHub with the
...
For issues with lf itself, see
[lf](https://github.com/gokcehan/lf).

## License

Packaging scripts in this repo are MIT-licensed. The packaged binaries
remain under their upstream license — see [lf](https://github.com/gokcehan/lf).
